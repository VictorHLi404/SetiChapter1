...
function createTaskObject(_taskID, _taskName, _taskDescription, _taskLength, _currentProgression, _isOptimizable, _puzzleType, _puzzleCode) constructor {
	...
	currentProgession = _currentProgression; // current length of time spent on task / task has been active, integer
